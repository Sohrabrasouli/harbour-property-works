...
export default function Home() {
  return (
    <main id="top">
      ...
      <div className="planner-wrap reveal"><ProjectPlanner /></div>
      ...
      <section className="area-section reveal" id="areas"><div><p className="eyebrow light">Service area</p><h2>Toronto at the centre.<br />The GTA within reach.</h2></div><div className="area-details"><MapPin size={30} weight="duotone" /><p>Toronto, North York, Etobicoke, Scarborough, Vaughan, Richmond Hill, Markham and Mississauga.</p><small>Location, access and project fit are confirmed during assessment.</small></div></section>

      <section className="final-cta reveal"><div><p className="eyebrow">Let’s plan your project</p><h2>A clearer space starts with a clear brief.</h2></div><div><p>Share the basics and Harbour can confirm the right next step.</p><a className="primary-button" href="#planner">Start my project<ArrowRight size={18} weight="bold" /></a><small>Final scope, availability, timing and pricing are confirmed after assessment.</small></div></section>
